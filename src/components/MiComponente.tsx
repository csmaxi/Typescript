...
* @see https://v0.dev/t/sukAKXqImzY
          ...
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
            <div className="grid gap-4 rounded-lg border p-6 bg-background">
              ...
              <p className="text-muted-foreground">
                Aprende los conceptos fundamentales de TypeScript, incluyendo tipos, variables, operadores y arrays.
              </p>
              <Link
                href="/basico"
            ...
            <div className="grid gap-4 rounded-lg border p-6 bg-background">
              ...
              <p className="text-muted-foreground">
                Profundiza en el uso de TypeScript en proyectos más complejos, incluyendo interfaces y
                genéricos.
              </p>
              <Link
                href="/intermedio"
            ...
            <div className="grid gap-4 rounded-lg border p-6 bg-background">
              ...
              <p className="text-muted-foreground">
                Aprende técnicas avanzadas de TypeScript, como intersecciones, alias y unión.
              </p>
              <Link
                href="/avanzado"
                className="inline-flex h-10 items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors hover:bg-primary/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50"
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid gap-12 md:grid-cols-2 lg:grid-cols-3">
            <div className="grid gap-4">
              ...
              <p className="text-muted-foreground">
                TypeScript te ayuda a escribir código más seguro y mantenible, lo que te permite ser más productivo.
              </p>
            </div>
            <div className="grid gap-4">
              <div className="bg-muted rounded-md flex items-center justify-center aspect-square w-12">
              ...
              <p className="text-muted-foreground">
                El sistema de tipos de TypeScript te ayuda a detectar errores en tiempo de compilación, lo que te
                permite escribir código más confiable.
              </p>
            </div>
            <div className="grid gap-4">
              <div className="bg-muted rounded-md flex items-center justify-center aspect-square w-12">
              ...
              <p className="text-muted-foreground">
                Aprender TypeScript te dará una ventaja competitiva en el mercado laboral, ya que es cada vez más
